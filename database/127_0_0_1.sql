...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2022 at 04:45 PM
...
--
CREATE DATABASE IF NOT EXISTS `projectcinema` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci;
USE `projectcinema`;
...
INSERT INTO `genres` (`id`, `movie_id`, `genre`, `main`) VALUES
(1, 1, 'anime', 1),
(2, 1, 'action', 1),
(3, 1, 'horror', NULL),
(4, 2, 'anime', 1),
