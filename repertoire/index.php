...
<body>
    <div id="repertoire-top">
        ...
        <div id=repertoire-days>
            <div class="repertoire-day noselect" onclick="currentSlide(1)"><?php $scripts->setCorrentDay(0); ?></div>
            <div class="repertoire-day noselect" onclick="currentSlide(2)"><?php $scripts->setCorrentDay(1); ?></div>
            <div class="repertoire-day noselect" onclick="currentSlide(3)"><?php $scripts->setCorrentDay(2); ?></div>
            <div class="repertoire-day noselect" onclick="currentSlide(4)"><?php $scripts->setCorrentDay(3); ?></div>
            <div class="repertoire-day noselect" onclick="currentSlide(5)"><?php $scripts->setCorrentDay(4); ?></div>
            <div class="repertoire-day noselect" onclick="currentSlide(6)"><?php $scripts->setCorrentDay(5); ?></div>
            <div class="repertoire-day noselect" onclick="currentSlide(7)"><?php $scripts->setCorrentDay(6); ?></div>
        </div>
    </div>
